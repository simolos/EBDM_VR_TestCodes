...
try:
    ...
    streamer.send_event("DecisionFeedback", {"choice": choice, "dur_DecisionFeedback": dur_DecisionFeedback}) # --> this means show the corresponding decision for dur_Feedback
